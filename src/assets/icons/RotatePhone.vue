...
<template>
    <svg viewBox="0 0 24 24" width="100" height="100" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#faae25">
        ...
        <g id="SVGRepo_iconCarrier">
            <path
                ...
                stroke="#faae25" stroke-width="1.5"></path>
            <path
                ...
                stroke="#faae25" stroke-width="1.5" stroke-linecap="round"></path>
            <path d="M11 5H6" stroke="#faae25" stroke-width="1.5" stroke-linecap="round"></path>
            <path d="M19 18V14" stroke="#faae25" stroke-width="1.5" stroke-linecap="round"></path>
            <path
                ...
                stroke="#faae25" stroke-width="1.5"></path>
            <path d="M20.5 6.98598L22 8C22 4.98532 19.8377 2.48275 17 2" stroke="#faae25" stroke-width="1.5"
