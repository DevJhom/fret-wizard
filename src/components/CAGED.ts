...
export const CAGED = {
    ...
    AShape: {
        E: [-10,-8,2,4,14,16],
        A: [-10,-9,-8,2,3,4,14,15,16],
        D: [-11,-8,1,4,13,16],
        G: [-11,-8,0,1,4,12,13,16],
        B: [-10,-8,2,4,5,14,16,17],
        e: [-10,-8,2,4,14,16],
    },
    GShape: {
        E: [-8,-5, 4,7, 16,19],
        A: [-9,-8,-5, 3,4,7, 15,16,19],
        D: [-8,-6,-5, 4,6,7, 16,18,19],
        G: [-8,-6, 4,6, 16,18],
        B: [-8,-7,-6, 4,5,6, 16,17,18],
        e: [-8,-5, 4,7, 16,19],
    },
    EShape: {
        E: [5,-3,-2, 7,9,10, 19,21,22],
        A: [-5,-3, 7,9, 19,21],
        D: [-6,-5,-4, 6,7,8, 18,19,20],
        G: [-6,-3, 6,9, 18,21],
        B: [-7,-6,-3, 5,6,9, 17,18,21],
        e: [-5,-3,-2, 7,9,10, 19,21,22],
    },
    DShape: {
        E: [-3,-2,-1, 9,10,11, 21,22,23],
        A: [-3,0, 9,12, 21],
        D: [-5,-4,-1, 7,8,11, 19,20,23],
        G: [-3,-1,0, 9,11,12, 21,23],
        B: [-3,-1, 9,11, 21,23],
        e: [-3,-2,-1, 9,10,11, 21,22,23],
    }
}
